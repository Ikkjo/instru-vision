...
function App() {
	const MNETV3_URL = "http://localhost:8000/mnetv3/model.json"
	const DEEP_CNN_URL = "http://localhost:8000/deep_cnn/model.json"
	...
	const onModelTypeChange = (e) => {
		...
		if (chosen==="mnetv3") {
			modelUrl = MNETV3_URL
		} else if (chosen==="deep_cnn") {
			modelUrl = DEEP_CNN_URL
		}
		loadModel(modelUrl)
	}
	...
	return (
		<div className="App">
			<h1>What kind of guitar is this?</h1>
